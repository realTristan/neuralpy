...
dogs_url = lambda page: "https://www.bing.com/images/search?q=dog&form=HDRSC4&first=" + str(page)
cats_url = lambda page: "https://www.bing.com/images/search?q=cat&form=HDRSC4&first=" + str(page)
